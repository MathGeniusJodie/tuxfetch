...
#define INTEL_GPU_COUNT 321
static struct keyval intel_gpus[INTEL_GPU_COUNT] = {
{0x0042,"HD (Ironlake)"},
{0x0046,"HD (Ironlake)"},
...
#define AMD_GPU_COUNT 379
struct keyval amd_gpus[AMD_GPU_COUNT] = {
{0x1304,"Kaveri"},
{0x1305,"Kaveri"},
{0x1306,"Kaveri"},
{0x1307,"Kaveri"},
...
#define NV_GPU_COUNT 911
struct keyval nv_gpus[NV_GPU_COUNT] = {
